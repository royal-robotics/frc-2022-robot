...
public class TestAuto extends AutoModeBase {
    public TestAuto(RobotContainer robotContainer) {
        ...
        this.addCommands(new AutoFollowCommand(drivetrainSubsystem, "WallBall4Ball1", 5, 3));
        this.addCommands(new AutoMoveShooter(shooterSubsystem, -21));
        this.addCommands(new AutoShootCommand(shooterSubsystem, 2900));
        this.addCommands(new AutoFollowCommand(drivetrainSubsystem, "WallBall4Ball2", 5, 3));
        //this.addCommands(new ParallelCommandGroup(new AutoPickupCommand(shooterSubsystem), new AutoFollowCommand(drivetrainSubsystem, "WallBall4Ball2", 5, 3)));
        ...
        this.addCommands(new ParallelCommandGroup(new AutoPickupCommand(shooterSubsystem), new AutoFollowCommand(drivetrainSubsystem, "WallBall4Ball3", 5, 3)));
