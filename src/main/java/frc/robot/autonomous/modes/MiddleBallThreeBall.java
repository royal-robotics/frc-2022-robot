...
public class MiddleBallThreeBall extends AutoModeBase {
    public MiddleBallThreeBall(RobotContainer robotContainer) {
        ...
        this.addCommands(new AutoShootCommand(shooterSubsystem, 2600));
        ...
        this.addCommands(new ParallelCommandGroup(new AutoRotate2Command(drivetrainSubsystem, 160), new AutoMoveShooter(shooterSubsystem, 25)));
